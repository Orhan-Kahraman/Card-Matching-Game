...
class SinglePlayerStarts extends StatelessWidget {
  const SinglePlayerStarts({super.key});
              ...
              child: Column(
                ...
                CustomElevatedButton(
                    ...
                    ontap: () {
                      ...
                      context
                          .read<SingleCubit>()
                          .ikilikOyun(context: context, sayi: 45);
                    }),
                verticalSpaceTiny,
                CustomElevatedButton(
                    title: Text(
                    ...
                    ontap: () {
                      ...
                      context
                          .read<SingleCubit>()
                          .dortlukOyun(context: context, sayi: 45);
                    }),
                verticalSpaceTiny,
                CustomElevatedButton(
                    title: Text(
                    ...
                    ontap: () {
                      ...
                      context
                          .read<SingleCubit>()
                          .sekizlikOyun(context: context, sayi: 45);
                    })
              ]));
        },
      ),
