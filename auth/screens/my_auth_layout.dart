...
class MyAuthLayout extends StatelessWidget {
  ...
  final String _mainTitle = "Memory Master";
  final String _signupText = "Hesap Oluştur";
  final String _signinText = "Giriş Yap";
  final String _harryPotterImage = "assets/images/Harry_Potter.png";
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                  width: width - 300 < height ? width * 0.8 : 500,
                  child: Image.asset(_harryPotterImage, fit: BoxFit.fill)),
